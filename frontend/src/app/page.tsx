      ...
      <div className="grid gap-6">
        ...
        <form action="/search" className="relative">
          ...
          <button
            type="submit"
            aria-label="Buscar"
            className="absolute inset-y-0 right-0 flex items-center rounded-r-lg px-3 text-muted-foreground outline-none hover:text-foreground focus-visible:ring-3 focus-visible:ring-ring/50"
          >
